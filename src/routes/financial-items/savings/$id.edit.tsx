...
import { SavingsForm } from "@/financial-items/components/SavingsForm";
    ...
    return (
      <div className="container mx-auto p-6 max-w-2xl">
        <div className="text-center py-12">
          <p className="text-lg text-muted-foreground">Savings account not found</p>
          <Button onClick={() => navigate({ to: "/financial-items/savings" })} className="mt-4">
            Back to Savings
          </Button>
        </div>
      </div>
  ...
  return (
    <div className="container mx-auto p-6 max-w-2xl">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold text-foreground">Edit Savings Account</h1>
        <p className="text-muted-foreground mt-1">Update your savings account details</p>
      </div>
