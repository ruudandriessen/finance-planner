...
import { CreditCard, Edit3, Home, Plus, User } from "lucide-react";
			...
			<div className="flex justify-between items-center mb-6">
				<div>
					...
					<p className="text-gray-600 mt-1">
						Total Debt: {formatCurrency(totalDebt)} • Monthly Payments:{" "}
					...
					{loans.map((loan: any) => (
						...
						>
							...
							<CardContent className="p-4 pt-0">
								...
								<p className="text-xs text-gray-600 mt-1">{loan.name}</p>
					...
					<CardContent className="flex flex-col items-center justify-center py-12 px-6">
						<div className="text-gray-600 text-center">
							...
							<p className="text-sm text-gray-600">
								Add your first loan or debt to get started
							</p>
						</div>
					</CardContent>
				</Card>
