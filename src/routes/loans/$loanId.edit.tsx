	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		if (formData.type === "credit_card") {
			...
			const remainingBalance = parseFloat(
				formData.remainingBalance || principal.toString(),
			);
		...
		return (
			<div className="container mx-auto p-6 max-w-2xl">
				<div className="text-center py-12">
					...
					<Button onClick={() => navigate({ to: "/loans" })} className="mt-4">
						Back to Loans
					</Button>
				</div>
			</div>
	...
	return (
		<div className="container mx-auto p-6 max-w-2xl">
			<div className="mb-6">
				...
				<p className="text-gray-600 mt-1">Update your loan details</p>
			</div>
					...
					<form onSubmit={handleSubmit} className="space-y-6">
						...
						<div>
							...
							<Select
								value={formData.type}
								onValueChange={(
									value: "mortgage" | "personal" | "credit_card",
